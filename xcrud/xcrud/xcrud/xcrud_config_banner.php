...
class Xcrud_config
{
    ...
    public static $upload_folder_def = '../../../writable/uploads/banners'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    public static $ajax_uri = 'xcrud_ajax_banner.php'; // main ajax file or url
