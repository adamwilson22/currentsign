...
<?php 
    ...
    SELECT `id`, `full_name`, `email`, `email_verified_at`, `password`, `remember_token`,
    `created_at`, `updated_at`, `mobile_number`, `country_code`, `otp_reset_password`, `otp_reset_password_expiration`, 
    `deleted_at`, `image` FROM `users` WHERE 1
    
    */
    
    
    $xcrud->columns('full_name,email,country_code,mobile_number');
    $xcrud->fields('full_name,email,country_code,mobile_number');
