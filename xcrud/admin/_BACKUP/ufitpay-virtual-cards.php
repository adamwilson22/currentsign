...
<?php 
    ...
    $xcrud->table('ufitpay_virtual_cards');
    ...
    $xcrud->where("vcard_card_id like '$search%' 
    or vcard_card_holder_id like '$search%'
    or vcard_name_on_card like '$search%'
    or vcard_card_number like '$search%'

    ");

    $xcrud->order_by('vcard_id','desc');
