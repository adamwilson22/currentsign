...
<?php 
    ...
    $xcrud->table('ufitpay_create_card_holders');
    ...
    $xcrud->where("cch_card_holder_id like '$search%' 
    or cch_first_name like '$search%'
    or cch_last_name like '$search%'

    ");

      $xcrud->order_by('cch_id','desc');
