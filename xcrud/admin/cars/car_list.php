...
require( dirname(dirname(dirname(__DIR__))) . '/axcrud-database.php');
...
<script>
    function get_car_models() {
        ...
        $.ajax({
            url: "<?php echo $base_url?>/admin/get-model-by-id", // Ensure proper Blade syntax for printing PHP variables
            method: 'GET',
            data: { id: maker_id },
            ...
            error: function(xhr, status, error) {
                ...
                alert('Error fetching car models.'); // Show error message to user
            }
        });
    }
...
<?php 
   ...
   $xcrud->field_callback('car_maker_id','maker_list_cars');

   $xcrud->field_callback('car_model_id','model_list_cars');
...
//SELECT `car_body_color_id`, `car_body_color_name`, `car_body_color_created_at`, `car_body_color_updated_at`, `car_body_color_deleted_at`, `car_body_color_admin_status` FROM `cars_body_colors` WHERE 1
//car_body_color_id
 $xcrud->relation('car_body_color_id','cars_body_colors','car_body_color_id','car_body_color_name' );
...
//SELECT `car_city_id`, `car_city_name`, `car_city_created_at`, `car_city_updated_at`, `car_city_deleted_at`, `car_city_admin_status` FROM `cars_cities` WHERE 1
 ...
 $xcrud->relation('car_city_id','cars_cities','car_city_id','car_city_name' );
...
//SELECT `car_rim_size_id`, `car_rim_size_name`, `car_rim_size_created_at`, `car_rim_size_updated_at`, `car_rim_size_deleted_at`, `car_rim_size_admin_status` FROM `cars_rim_sizes` WHERE 1
 ...
 $xcrud->relation('car_rim_sizes_id','cars_rim_sizes','car_rim_size_id','car_rim_size_name' );
...
//SELECT `car_type_id`, `car_type_name`, `car_type_created_at`, `car_type_updated_at`, `car_type_deleted_at`, `car_type_admin_status` FROM `cars_types` WHERE 1
 ...
 $xcrud->relation('car_type_id','cars_types','car_type_id','car_type_name' );
...
//SELECT `car_condition_id`, `car_condition_name`, `car_condition_created_at`, `car_condition_updated_at`, `car_condition_deleted_at`, `car_condition_admin_status` FROM `cars_conditions` WHERE 1
 ...
 $xcrud->relation('car_condition_id','cars_conditions','car_condition_id','car_condition_name' );
...
//SELECT `car_under_warranty_id`, `car_under_warranty_name`, `car_under_warranty_created_at`, `car_under_warranty_updated_at`, `car_under_warranty_deleted_at`, `car_under_warranty_admin_status` FROM `cars_under_warranties` WHERE 1
 ...
 $xcrud->relation('car_under_warranty_id','cars_under_warranties','car_under_warranty_id','car_under_warranty_name' );
