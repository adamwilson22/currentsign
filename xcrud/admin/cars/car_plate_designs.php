...
<?php 
    ...
    */
    ...
    $xcrud->columns('car_name,car_class_id');
    $xcrud->fields('car_name,car_class_id');
   ...
   /*******************************************/
         ...
         $query_country = "SELECT * FROM `cars_classes` WHERE 1";  
         ...
         {
                  $select[$item['car_classes_id']] = $item['car_classes_name'];
         }
