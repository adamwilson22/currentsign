<?php 
   $seo['short_title']       = "Car Makers"; 
   $seo['full_title']        = "Car Makers"; 
   $seo['short_description'] = "Car Makers"; 
   $seo['full_description']  = "Car Makers"; 
   $seo['keywords']          = "Car Makers"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Makers</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_makers.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
