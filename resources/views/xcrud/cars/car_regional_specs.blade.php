<?php 
   $seo['short_title']       = "Car Regional Specs"; 
   $seo['full_title']        = "Car Regional Specs"; 
   $seo['short_description'] = "Car Regional Specs"; 
   $seo['full_description']  = "Car Regional Specs"; 
   $seo['keywords']          = "Car Regional Specs"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Regional Specs</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_regional_specs.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
