<?php 
   $seo['short_title']       = "Car Drive Types"; 
   $seo['full_title']        = "Car Drive Types"; 
   $seo['short_description'] = "Car Drive Types"; 
   $seo['full_description']  = "Car Drive Types"; 
   $seo['keywords']          = "Car Drive Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Drive Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_drive_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
