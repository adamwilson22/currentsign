<?php 
   $seo['short_title']       = "Car Cities"; 
   $seo['full_title']        = "Car Cities"; 
   $seo['short_description'] = "Car Cities"; 
   $seo['full_description']  = "Car Cities"; 
   $seo['keywords']          = "Car Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Cities</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car-cities.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
