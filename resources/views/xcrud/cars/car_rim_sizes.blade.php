<?php 
   $seo['short_title']       = "Car Rim Sizes"; 
   $seo['full_title']        = "Car Rim Sizes"; 
   $seo['short_description'] = "Car Rim Sizes"; 
   $seo['full_description']  = "Car Rim Sizes"; 
   $seo['keywords']          = "Car Rim Sizes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Rim Sizes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_rim_sizes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
