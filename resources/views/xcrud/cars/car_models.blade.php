<?php 
   $seo['short_title']       = "Car Models"; 
   $seo['full_title']        = "Car Models"; 
   $seo['short_description'] = "Car Models"; 
   $seo['full_description']  = "Car Models"; 
   $seo['keywords']          = "Car Models"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Models</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_models.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
