<?php 
   $seo['short_title']       = "Car Types"; 
   $seo['full_title']        = "Car Types"; 
   $seo['short_description'] = "Car Types"; 
   $seo['full_description']  = "Car Types"; 
   $seo['keywords']          = "Car Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
