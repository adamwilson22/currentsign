<?php 
   $seo['short_title']       = "Car Service History"; 
   $seo['full_title']        = "Car Service History"; 
   $seo['short_description'] = "Car Service History"; 
   $seo['full_description']  = "Car Service History"; 
   $seo['keywords']          = "Car Service History"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Service History</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_service_history.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
