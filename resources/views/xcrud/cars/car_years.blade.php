<?php 
   $seo['short_title']       = "Car Years"; 
   $seo['full_title']        = "Car Years"; 
   $seo['short_description'] = "Car Years"; 
   $seo['full_description']  = "Car Years"; 
   $seo['keywords']          = "Car Years"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Years</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_years.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
