<?php 
   $seo['short_title']       = "Car Horse Powers"; 
   $seo['full_title']        = "Car Horse Powers"; 
   $seo['short_description'] = "Car Horse Powers"; 
   $seo['full_description']  = "Car Horse Powers"; 
   $seo['keywords']          = "Car Horse Powers"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Horse Powers</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_horse_powers.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
