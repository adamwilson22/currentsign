<?php 
   $seo['short_title']       = "Car Body Colors"; 
   $seo['full_title']        = "Car Body Colors"; 
   $seo['short_description'] = "Car Body Colors"; 
   $seo['full_description']  = "Car Body Colors"; 
   $seo['keywords']          = "Car Body Colors"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Body Colors</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_body_colors.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
