<?php 
   $seo['short_title']       = "Car Interior Colors"; 
   $seo['full_title']        = "Car Interior Colors"; 
   $seo['short_description'] = "Car Interior Colors"; 
   $seo['full_description']  = "Car Interior Colors"; 
   $seo['keywords']          = "Car Interior Colors"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Interior Colors</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_interior_colors.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
