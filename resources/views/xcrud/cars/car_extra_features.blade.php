<?php 
   $seo['short_title']       = "Car Extra Features"; 
   $seo['full_title']        = "Car Extra Features"; 
   $seo['short_description'] = "Car Extra Features"; 
   $seo['full_description']  = "Car Extra Features"; 
   $seo['keywords']          = "Car Extra Features"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Extra Features</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_extra_features.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
