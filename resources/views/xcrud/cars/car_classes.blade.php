<?php 
   $seo['short_title']       = "Car Classes"; 
   $seo['full_title']        = "Car Classes"; 
   $seo['short_description'] = "Car Classes"; 
   $seo['full_description']  = "Car Classes"; 
   $seo['keywords']          = "Car Classes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Classes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_classes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
