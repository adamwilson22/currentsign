<?php 
   $seo['short_title']       = "Car Plate Codes"; 
   $seo['full_title']        = "Car Plate Codes"; 
   $seo['short_description'] = "Car Plate Codes"; 
   $seo['full_description']  = "Car Plate Codes"; 
   $seo['keywords']          = "Car Plate Codes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Plate Codes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_plate_codes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
