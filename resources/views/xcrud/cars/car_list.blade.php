<?php 
   $seo['short_title']       = "Car List"; 
   $seo['full_title']        = "Car List"; 
   $seo['short_description'] = "Car List"; 
   $seo['full_description']  = "Car List"; 
   $seo['keywords']          = "Car List"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car List</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_list.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
