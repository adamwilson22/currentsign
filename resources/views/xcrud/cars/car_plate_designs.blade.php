<?php 
   $seo['short_title']       = "Car Plate Designs"; 
   $seo['full_title']        = "Car Plate Designs"; 
   $seo['short_description'] = "Car Plate Designs"; 
   $seo['full_description']  = "Car Plate Designs"; 
   $seo['keywords']          = "Car Plate Designs"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Plate Designs</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_plate_designs.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
