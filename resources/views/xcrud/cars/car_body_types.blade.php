<?php 
   $seo['short_title']       = "Car Body Types"; 
   $seo['full_title']        = "Car Body Types"; 
   $seo['short_description'] = "Car Body Types"; 
   $seo['full_description']  = "Car Body Types"; 
   $seo['keywords']          = "Car Body Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Body Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_body_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
