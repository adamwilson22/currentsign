<?php 
   $seo['short_title']       = "Car Plate Sources"; 
   $seo['full_title']        = "Car Plate Sources"; 
   $seo['short_description'] = "Car Plate Sources"; 
   $seo['full_description']  = "Car Plate Sources"; 
   $seo['keywords']          = "Car Plate Sources"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Car Plate Sources</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cars/car_plate_sources.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
