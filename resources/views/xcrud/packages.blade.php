<?php 
   $seo['short_title']       = "Packages"; 
   $seo['full_title']        = "Packages"; 
   $seo['short_description'] = "Packages"; 
   $seo['full_description']  = "Packages"; 
   $seo['keywords']          = "Packages"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/packages.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
