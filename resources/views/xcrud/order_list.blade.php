<?php 
   $seo['short_title']       = "Order Lists"; 
   $seo['full_title']        = "Order Lists"; 
   $seo['short_description'] = "Order Lists"; 
   $seo['full_description']  = "Order Lists"; 
   $seo['keywords']          = "Order Lists"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/order_list.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
