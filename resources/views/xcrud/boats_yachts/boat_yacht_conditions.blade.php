<?php 
   $seo['short_title']       = "Boat/Yacht Conditions"; 
   $seo['full_title']        = "Boat/Yacht Conditions"; 
   $seo['short_description'] = "Boat/Yacht Conditions"; 
   $seo['full_description']  = "Boat/Yacht Conditions"; 
   $seo['keywords']          = "Boat/Yacht Conditions"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Boat/Yacht Conditions</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/boats_yachts/boat_yacht_conditions.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
