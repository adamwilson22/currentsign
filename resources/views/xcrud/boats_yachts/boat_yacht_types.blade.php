<?php 
   $seo['short_title']       = "Boat/Yacht Types"; 
   $seo['full_title']        = "Boat/Yacht Types"; 
   $seo['short_description'] = "Boat/Yacht Types"; 
   $seo['full_description']  = "Boat/Yacht Types"; 
   $seo['keywords']          = "Boat/Yacht Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Boat/Yacht Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/boats_yachts/boat_yacht_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
