<?php 
   $seo['short_title']       = "Boat/Yacht Makers"; 
   $seo['full_title']        = "Boat/Yacht Makers"; 
   $seo['short_description'] = "Boat/Yacht Makers"; 
   $seo['full_description']  = "Boat/Yacht Makers"; 
   $seo['keywords']          = "Boat/Yacht Makers"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Boat/Yacht Makers</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/boats_yachts/boat_yacht_makers.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
