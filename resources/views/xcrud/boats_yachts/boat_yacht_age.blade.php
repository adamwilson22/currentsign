<?php 
   $seo['short_title']       = "Boat/Yacht Age"; 
   $seo['full_title']        = "Boat/Yacht Age"; 
   $seo['short_description'] = "Boat/Yacht Age"; 
   $seo['full_description']  = "Boat/Yacht Age"; 
   $seo['keywords']          = "Boat/Yacht Age"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Boat/Yacht Age</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/boats_yachts/boat_yacht_age.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
