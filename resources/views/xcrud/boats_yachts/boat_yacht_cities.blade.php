<?php 
   $seo['short_title']       = "Boat/Yacht Cities"; 
   $seo['full_title']        = "Boat/Yacht Cities"; 
   $seo['short_description'] = "Boat/Yacht Cities"; 
   $seo['full_description']  = "Boat/Yacht Cities"; 
   $seo['keywords']          = "Boat/Yacht Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Boat/Yacht Cities</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/boats_yachts/boat_yacht_cities.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
