<?php 
   $seo['short_title']       = "Auto Accessory Sub Categories"; 
   $seo['full_title']        = "Auto Accessory Sub Categories"; 
   $seo['short_description'] = "Auto Accessory Sub Categories"; 
   $seo['full_description']  = "Auto Accessory Sub Categories"; 
   $seo['keywords']          = "Auto Accessory Sub Categories"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Auto Accessory Sub Categories</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/auto_accessories_parts/auto_accessories_parts_sub_category.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
