<?php 
   $seo['short_title']       = "Auto Accessory Type"; 
   $seo['full_title']        = "Auto Accessory Type"; 
   $seo['short_description'] = "Auto Accessory Type"; 
   $seo['full_description']  = "Auto Accessory Type"; 
   $seo['keywords']          = "Auto Accessory Type"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Auto Accessory Type</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/auto_accessories_parts/auto_accessories_parts_type.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
