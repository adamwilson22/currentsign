<?php 
   $seo['short_title']       = "Auto Accessory Part's Age"; 
   $seo['full_title']        = "Auto Accessory Part's Age"; 
   $seo['short_description'] = "Auto Accessory Part's Age"; 
   $seo['full_description']  = "Auto Accessory Part's Age"; 
   $seo['keywords']          = "Auto Accessory Part's Age"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Auto Accessory Part's Age</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/auto_accessories_parts/auto_accessories_parts_age.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
