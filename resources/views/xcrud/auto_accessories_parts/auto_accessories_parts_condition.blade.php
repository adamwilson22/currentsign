<?php 
   $seo['short_title']       = "Auto Accessory Condition"; 
   $seo['full_title']        = "Auto Accessory Condition"; 
   $seo['short_description'] = "Auto Accessory Condition"; 
   $seo['full_description']  = "Auto Accessory Condition"; 
   $seo['keywords']          = "Auto Accessory Condition"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Auto Accessory Condition</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/auto_accessories_parts/auto_accessories_parts_condition.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
