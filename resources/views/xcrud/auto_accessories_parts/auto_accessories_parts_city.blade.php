<?php 
   $seo['short_title']       = "Auto Accessory Cities"; 
   $seo['full_title']        = "Auto Accessory Cities"; 
   $seo['short_description'] = "Auto Accessory Cities"; 
   $seo['full_description']  = "Auto Accessory Cities"; 
   $seo['keywords']          = "Auto Accessory Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Auto Accessory Cities</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/auto_accessories_parts/auto_accessories_parts_city.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
