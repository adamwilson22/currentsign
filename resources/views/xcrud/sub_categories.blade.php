<?php 
   $seo['short_title']       = "Sub Category"; 
   $seo['full_title']        = "Sub Category"; 
   $seo['short_description'] = "Sub Category"; 
   $seo['full_description']  = "Sub Category"; 
   $seo['keywords']          = "Sub Category"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Sub Category</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/category-sub.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
