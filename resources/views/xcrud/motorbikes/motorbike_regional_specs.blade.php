<?php 
   $seo['short_title']       = "MotorBike Regional Specs"; 
   $seo['full_title']        = "MotorBike Regional Specs"; 
   $seo['short_description'] = "MotorBike Regional Specs"; 
   $seo['full_description']  = "MotorBike Regional Specs"; 
   $seo['keywords']          = "MotorBike Regional Specs"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Regional Specs</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_regional_specs.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
