<?php 
   $seo['short_title']       = "MotorBike Interior Colors"; 
   $seo['full_title']        = "MotorBike Interior Colors"; 
   $seo['short_description'] = "MotorBike Interior Colors"; 
   $seo['full_description']  = "MotorBike Interior Colors"; 
   $seo['keywords']          = "MotorBike Interior Colors"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Interior Colors</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_interior_colors.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
