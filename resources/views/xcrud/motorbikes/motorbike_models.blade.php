<?php 
   $seo['short_title']       = "MotorBike Models"; 
   $seo['full_title']        = "MotorBike Models"; 
   $seo['short_description'] = "MotorBike Models"; 
   $seo['full_description']  = "MotorBike Models"; 
   $seo['keywords']          = "MotorBike Models"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Models</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_models.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
