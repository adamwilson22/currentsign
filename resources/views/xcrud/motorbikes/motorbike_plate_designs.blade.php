<?php 
   $seo['short_title']       = "MotorBike Plate Designs"; 
   $seo['full_title']        = "MotorBike Plate Designs"; 
   $seo['short_description'] = "MotorBike Plate Designs"; 
   $seo['full_description']  = "MotorBike Plate Designs"; 
   $seo['keywords']          = "MotorBike Plate Designs"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Plate Designs</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_plate_designs.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
