<?php 
   $seo['short_title']       = "MotorBike No Of Seats"; 
   $seo['full_title']        = "MotorBike No Of Seats"; 
   $seo['short_description'] = "MotorBike No Of Seats"; 
   $seo['full_description']  = "MotorBike No Of Seats"; 
   $seo['keywords']          = "MotorBike No Of Seats"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Number Of Seats</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_no_of_seats.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
