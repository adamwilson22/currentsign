<?php 
   $seo['short_title']       = "MotorBike Cities"; 
   $seo['full_title']        = "MotorBike Cities"; 
   $seo['short_description'] = "MotorBike Cities"; 
   $seo['full_description']  = "MotorBike Cities"; 
   $seo['keywords']          = "MotorBike Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Cities</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_cities.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
