<?php 
   $seo['short_title']       = "MotorBike Types"; 
   $seo['full_title']        = "MotorBike Types"; 
   $seo['short_description'] = "MotorBike Types"; 
   $seo['full_description']  = "MotorBike Types"; 
   $seo['keywords']          = "MotorBike Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
