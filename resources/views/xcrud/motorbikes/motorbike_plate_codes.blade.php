<?php 
   $seo['short_title']       = "MotorBike Plate Codes"; 
   $seo['full_title']        = "MotorBike Plate Codes"; 
   $seo['short_description'] = "MotorBike Plate Codes"; 
   $seo['full_description']  = "MotorBike Plate Codes"; 
   $seo['keywords']          = "MotorBike Plate Codes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Plate Codes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_plate_codes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
