<?php 
   $seo['short_title']       = "MotorBike Years"; 
   $seo['full_title']        = "MotorBike Years"; 
   $seo['short_description'] = "MotorBike Years"; 
   $seo['full_description']  = "MotorBike Years"; 
   $seo['keywords']          = "MotorBike Years"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Years</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_years.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
