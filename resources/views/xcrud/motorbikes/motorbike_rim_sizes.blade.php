<?php 
   $seo['short_title']       = "MotorBike Rim Sizes"; 
   $seo['full_title']        = "MotorBike Rim Sizes"; 
   $seo['short_description'] = "MotorBike Rim Sizes"; 
   $seo['full_description']  = "MotorBike Rim Sizes"; 
   $seo['keywords']          = "MotorBike Rim Sizes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Rim Sizes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_rim_sizes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
