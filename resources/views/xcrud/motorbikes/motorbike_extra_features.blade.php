<?php 
   $seo['short_title']       = "MotorBike Extra Features"; 
   $seo['full_title']        = "MotorBike Extra Features"; 
   $seo['short_description'] = "MotorBike Extra Features"; 
   $seo['full_description']  = "MotorBike Extra Features"; 
   $seo['keywords']          = "MotorBike Extra Features"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Extra Features</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_extra_features.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
