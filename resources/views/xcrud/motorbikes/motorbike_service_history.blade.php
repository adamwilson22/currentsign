<?php 
   $seo['short_title']       = "MotorBike Service History"; 
   $seo['full_title']        = "MotorBike Service History"; 
   $seo['short_description'] = "MotorBike Service History"; 
   $seo['full_description']  = "MotorBike Service History"; 
   $seo['keywords']          = "MotorBike Service History"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Service History</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_service_history.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
