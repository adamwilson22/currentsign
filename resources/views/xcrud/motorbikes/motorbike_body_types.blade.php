<?php 
   $seo['short_title']       = "MotorBike Body Types"; 
   $seo['full_title']        = "MotorBike Body Types"; 
   $seo['short_description'] = "MotorBike Body Types"; 
   $seo['full_description']  = "MotorBike Body Types"; 
   $seo['keywords']          = "MotorBike Body Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Body Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_body_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
