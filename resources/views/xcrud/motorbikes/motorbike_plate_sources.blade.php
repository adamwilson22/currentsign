<?php 
   $seo['short_title']       = "MotorBike Plate Sources"; 
   $seo['full_title']        = "MotorBike Plate Sources"; 
   $seo['short_description'] = "MotorBike Plate Sources"; 
   $seo['full_description']  = "MotorBike Plate Sources"; 
   $seo['keywords']          = "MotorBike Plate Sources"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Plate Sources</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_plate_sources.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
