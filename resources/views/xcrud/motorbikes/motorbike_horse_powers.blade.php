<?php 
   $seo['short_title']       = "MotorBike Horse Powers"; 
   $seo['full_title']        = "MotorBike Horse Powers"; 
   $seo['short_description'] = "MotorBike Horse Powers"; 
   $seo['full_description']  = "MotorBike Horse Powers"; 
   $seo['keywords']          = "MotorBike Horse Powers"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Horse Powers</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_horse_powers.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
