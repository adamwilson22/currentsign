<?php 
   $seo['short_title']       = "MotorBike Drive Types"; 
   $seo['full_title']        = "MotorBike Drive Types"; 
   $seo['short_description'] = "MotorBike Drive Types"; 
   $seo['full_description']  = "MotorBike Drive Types"; 
   $seo['keywords']          = "MotorBike Drive Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Drive Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_drive_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
