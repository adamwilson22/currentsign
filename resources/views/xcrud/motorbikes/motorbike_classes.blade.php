<?php 
   $seo['short_title']       = "MotorBike Classes"; 
   $seo['full_title']        = "MotorBike Classes"; 
   $seo['short_description'] = "MotorBike Classes"; 
   $seo['full_description']  = "MotorBike Classes"; 
   $seo['keywords']          = "MotorBike Classes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Classes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_classes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
