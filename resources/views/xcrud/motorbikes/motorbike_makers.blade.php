<?php 
   $seo['short_title']       = "MotorBike Makers"; 
   $seo['full_title']        = "MotorBike Makers"; 
   $seo['short_description'] = "MotorBike Makers"; 
   $seo['full_description']  = "MotorBike Makers"; 
   $seo['keywords']          = "MotorBike Makers"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Makers</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_makers.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
