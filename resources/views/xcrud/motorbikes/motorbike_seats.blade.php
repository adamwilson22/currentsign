<?php 
   $seo['short_title']       = "MotorBike List"; 
   $seo['full_title']        = "MotorBike List"; 
   $seo['short_description'] = "MotorBike List"; 
   $seo['full_description']  = "MotorBike List"; 
   $seo['keywords']          = "MotorBike List"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike List</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_list.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
