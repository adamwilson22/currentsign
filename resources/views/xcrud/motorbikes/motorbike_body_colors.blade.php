<?php 
   $seo['short_title']       = "MotorBike Body Colors"; 
   $seo['full_title']        = "MotorBike Body Colors"; 
   $seo['short_description'] = "MotorBike Body Colors"; 
   $seo['full_description']  = "MotorBike Body Colors"; 
   $seo['keywords']          = "MotorBike Body Colors"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">MotorBike Body Colors</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/motorbikes/motorbike_body_colors.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
