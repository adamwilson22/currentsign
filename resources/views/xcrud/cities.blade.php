<?php 
   $seo['short_title']       = "Cities"; 
   $seo['full_title']        = "Cities"; 
   $seo['short_description'] = "Cities"; 
   $seo['full_description']  = "Cities"; 
   $seo['keywords']          = "Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/cities.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
