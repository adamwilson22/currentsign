<?php 
   $seo['short_title']       = "Trucks & Heavy Vehicles Body Types"; 
   $seo['full_title']        = "Trucks & Heavy Vehicles Body Types"; 
   $seo['short_description'] = "Trucks & Heavy Vehicles Body Types"; 
   $seo['full_description']  = "Trucks & Heavy Vehicles Body Types"; 
   $seo['keywords']          = "Trucks & Heavy Vehicles Body Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Trucks & Heavy Vehicles Body Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/trucks_and_heavy_vehicles/trucks_and_heavy_vehicle_body_types.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
