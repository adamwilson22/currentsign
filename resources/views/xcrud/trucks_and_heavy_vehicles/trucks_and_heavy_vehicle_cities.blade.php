<?php 
   $seo['short_title']       = "Trucks & Heavy Vehicles Cities"; 
   $seo['full_title']        = "Trucks & Heavy Vehicles Cities"; 
   $seo['short_description'] = "Trucks & Heavy Vehicles Cities"; 
   $seo['full_description']  = "Trucks & Heavy Vehicles Cities"; 
   $seo['keywords']          = "Trucks & Heavy Vehicles Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Trucks & Heavy Vehicles Cities</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/trucks_and_heavy_vehicles/trucks_and_heavy_vehicle_cities.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
