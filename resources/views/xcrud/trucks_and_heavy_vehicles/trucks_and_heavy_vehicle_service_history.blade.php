<?php 
   $seo['short_title']       = "Trucks & Heavy Vehicles Service History"; 
   $seo['full_title']        = "Trucks & Heavy Vehicles Service History"; 
   $seo['short_description'] = "Trucks & Heavy Vehicles Service History"; 
   $seo['full_description']  = "Trucks & Heavy Vehicles Service History"; 
   $seo['keywords']          = "Trucks & Heavy Vehicles Service History"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Trucks & Heavy Vehicles Service History</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/trucks_and_heavy_vehicles/trucks_and_heavy_vehicle_service_history.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
