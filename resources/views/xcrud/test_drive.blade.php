<?php 
   $seo['short_title']       = "Test Drive"; 
   $seo['full_title']        = "Test Drive"; 
   $seo['short_description'] = "Test Drive"; 
   $seo['full_description']  = "Test Drive"; 
   $seo['keywords']          = "Test Drive"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Test Drive</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/test_drive.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
