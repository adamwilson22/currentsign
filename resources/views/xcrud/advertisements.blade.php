<?php 
   $seo['short_title']       = "Advertisements"; 
   $seo['full_title']        = "Advertisements"; 
   $seo['short_description'] = "Advertisements"; 
   $seo['full_description']  = "Advertisements"; 
   $seo['keywords']          = "Advertisements"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/advertisements.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
