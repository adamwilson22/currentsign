<?php 
   $seo['short_title']       = "Category"; 
   $seo['full_title']        = "Category"; 
   $seo['short_description'] = "Category"; 
   $seo['full_description']  = "Category"; 
   $seo['keywords']          = "Category"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/category.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
