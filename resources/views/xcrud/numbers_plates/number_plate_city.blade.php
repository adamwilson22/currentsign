<?php 
   $seo['short_title']       = "Number Plate Cities"; 
   $seo['full_title']        = "Number Plate Cities"; 
   $seo['short_description'] = "Number Plate Cities"; 
   $seo['full_description']  = "Number Plate Cities"; 
   $seo['keywords']          = "Number Plate Cities"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Number Plate Cities</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/numbers_plates/number_plate_city.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
