<?php 
   $seo['short_title']       = "Number Plate Types"; 
   $seo['full_title']        = "Number Plate Types"; 
   $seo['short_description'] = "Number Plate Types"; 
   $seo['full_description']  = "Number Plate Types"; 
   $seo['keywords']          = "Number Plate Types"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Number Plate Types</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/numbers_plates/number_plate_type.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
