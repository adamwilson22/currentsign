<?php 
   $seo['short_title']       = "Number Plate Designs"; 
   $seo['full_title']        = "Number Plate Designs"; 
   $seo['short_description'] = "Number Plate Designs"; 
   $seo['full_description']  = "Number Plate Designs"; 
   $seo['keywords']          = "Number Plate Designs"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Number Plate Designs</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/numbers_plates/number_plate_designs.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
