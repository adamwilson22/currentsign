<?php 
   $seo['short_title']       = "Number Plate Codes"; 
   $seo['full_title']        = "Number Plate Codes"; 
   $seo['short_description'] = "Number Plate Codes"; 
   $seo['full_description']  = "Number Plate Codes"; 
   $seo['keywords']          = "Number Plate Codes"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Number Plate Codes</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/numbers_plates/number_plate_codes.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
