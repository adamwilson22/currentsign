<?php 
   $seo['short_title']       = "Number Plate Sources"; 
   $seo['full_title']        = "Number Plate Sources"; 
   $seo['short_description'] = "Number Plate Sources"; 
   $seo['full_description']  = "Number Plate Sources"; 
   $seo['keywords']          = "Number Plate Sources"; 
      ...
      <div class="card">
         <div class="card-body">
            <div class="pull-right" style="display: inline;">
               ...
               <h3 style="display: inline;">Number Plate Sources</h3>
            </div>
      ...
      <div class="card">
         <div class="card-body">
            <div class="table-responsive">
               ...
               <iframe id="myIframe" src="<? echo url(''); ?>/xcrud/admin/numbers_plates/number_plate_sources.php?search=<?php echo @$_REQUEST['search']; ?>"></iframe>
               <script>
