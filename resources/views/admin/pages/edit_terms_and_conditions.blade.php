   ...
   google.maps.event.addDomListener(window, 'load', initialize);
    ...
    <div>
        ...
        <p class="breadcrumbs"><span><a href="index.html">Home</a></span>
            <span><i class="mdi mdi-chevron-right"></i></span>Terms and Conditions</p>
    </div>
...
@endif
      ...
      <form method="POST" action="{{ route('terms_and_conditions.save', ['id' => $id]) }}" enctype="multipart/form-data" >
           @csrf
    ...
    <div class="ec-vendor-upload-detail">
        <div class="row">
            ...
            <div class="col-md-12">
               ...
               <textarea class="form-control" name="tac_text" id="description">{{ $terms_and_conditions->tac_text }}</textarea>
            </div>
