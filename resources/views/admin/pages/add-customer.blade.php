@include('admin.include.header')
    ...
    <div>
        ...
        <p class="breadcrumbs"><span><a href="index.html">Home</a></span>
            <span><i class="mdi mdi-chevron-right"></i></span>Add Customer</p>
    </div>
    <div>
...
@endif
      ...
      <form method="POST" action="{{ route('customers.save') }}" enctype="multipart/form-data" >
           @csrf
								<div class="card-body">
    ...
    <div class="ec-vendor-upload-detail">
        <div class="row g-3">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" name="full_name" id="firstName" value="">
            </div>
            ...
            <!--<div class="col-md-12">
             ...
             <input type="email" class="form-control" name="email"  id="lastName" value="">
            </div>
            <div class="col-md-12">
                    <label for="lastName">Password</label> 
                    <input type="password" class="form-control"  name="password"  id="lastName" value="">
            </div>
            
            <div class="col-md-12">
               <label for="firstName">DOB</label>
              <input type="text" class="form-control" name="dob" id="" value="">
            </div>
