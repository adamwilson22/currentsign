   ...
   google.maps.event.addDomListener(window, 'load', initialize);
    ...
    <div>
        ...
        <p class="breadcrumbs"><span><a href="index.html">Home</a></span>
            <span><i class="mdi mdi-chevron-right"></i></span>Privacy Policies</p>
    </div>
...
@endif
      ...
      <form method="POST" action="{{ route('privacy_policies.save', ['id' => $id]) }}" enctype="multipart/form-data" >
           @csrf
    ...
    <div class="ec-vendor-upload-detail">
        <div class="row">
            ...
            <div class="col-md-12">
               ...
               <textarea class="form-control" name="privacy_policy_text" id="description">{{ $privacy_policies->privacy_policy_text }}</textarea>
            </div>
