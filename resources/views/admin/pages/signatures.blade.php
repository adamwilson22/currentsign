@include('admin.include.header')
    ...
    <div>
        <h1> Signatures Pdf List</h1>
        <p class="breadcrumbs"><span><a href="dashboard.html">Welcome</a></span>
            <span><i class="mdi mdi-chevron-right"></i></span>Signatures Pdf
        </p>
						...
						<div class="col-12">
							...
							<div class="ec-vendor-list card card-default">
                         	...
                         	<tbody>
                                ...
                                <td>{{ $user->email }}</td>     
                                    <td>
                                    @if($user->signature && Str::endsWith($user->signature, '.pdf'))
                                    <a href="{{ asset('public/'.$user->signature) }}" target="_blank">View PDF</a>
                                    @elseif($user->signature && (Str::endsWith($user->signature, ['.jpg', '.jpeg', '.png', '.gif'])))
                                    <img class="vendor-thumb" 
                                    src="{{ asset('public/'.$user->signature) }}" 
                                    alt="user profile" 
