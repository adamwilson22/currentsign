...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/home2/technz1m/public_html/techno_public_html/SERVER-PHP-8-3.TECHNORIZEN.COM/motordxb/phpMyAdmin/database/templates/database/export/index.twig");
    }
}
